                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">For add fruity-tone product</p>
                        </div>
                ...
                <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                    <form action="{{ route('adminpage.stock.fruity-tone.add') }}" method="POST" class="form form-horizontal">
                                            @csrf
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-sm-12 d-flex justify-content-end">
                                                        ...
                                                        <a href="{{ url('admin/stock/fruity-tone') }}" class="btn btn-primary me-1 mb-1">Back</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
